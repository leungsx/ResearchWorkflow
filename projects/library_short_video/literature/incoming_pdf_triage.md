...
|---|---|---|---|---|---|
| 公共图书馆短视频公众平台建设现状分析_曾一昕.pdf | `cnki_2020_5ca581e54f` | metadata-only | 服务价值指标 | high | `intake_to_stable_pdf` |
| 我国省级公共图书馆短视频服务运营探析——基于抖音App的数据分析_隋鑫.pdf | `cnki_2021_2ba9195a8a` | metadata-only | 服务价值指标 | high | `intake_to_stable_pdf` |
...
| 政务短视频如何爆发影响力_基于政务抖音号的内容分析_王程伟.pdf | unmatched | unmatched | 待判断 | unknown | `external_comparison_or_ignore` |
