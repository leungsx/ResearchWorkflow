...
这个项目已经从“准备检索”推进到“真实 CNKI 检索 + 授权全文组织 + 每日推荐 + 10 篇文献带读 + 5 篇正式 HTML 精读”。当前已收敛为一个主问题：图书馆短视频的可见平台互动，如何被转译为数字阅读推广中的可观察服务价值；2026-07-03 已补入阅读服务类短视频传播效果组态文献。
...
| CNKI 检索结果/入库 | 项目矩阵 61 条；CNKI 检索结果曾刷新到 914 条 | [literature_matrix.csv](/Users/leung/ResearchWorkflow/library/literature_matrix.csv) |
...
| 授权全文 | 10 篇已组织，其中王磊 2025 仍保留在 incoming PDF 路径 | [PDF 文件夹](/Users/leung/ResearchWorkflow/library/pdfs/library_short_video/) |
| CAJ 转 PDF | 当前学习集已跑通 | [CAJ 转换记录](/Users/leung/ResearchWorkflow/projects/library_short_video/literature/caj_conversion/) |
| Reader | 10/10 已生成 | [readers](/Users/leung/ResearchWorkflow/projects/library_short_video/literature/readers/README.md) |
| 论文上下文包 | 已读 9 篇已生成，用于省 token 带读 | [context_packs](/Users/leung/ResearchWorkflow/projects/library_short_video/literature/context_packs/) |
| 今日推荐 | 2026-07-03 主读已完成王磊 2025 阅读服务类短视频传播效果组态论文精读；下一篇优先补多模态用户体验或服务转化数据文献 | [今日精读入口](/Users/leung/ResearchWorkflow/paper_reading/today.html) |
...
| 创新/局限/机会台账 | 10 张卡片 | [innovation_limitation_bank.md](/Users/leung/ResearchWorkflow/projects/library_short_video/literature/innovation_limitation_bank.md) |
| 文献综述工作台 | 已建立；已收敛主问题、2 个子问题和“平台互动-服务触达-阅读推广结果”指标草图，新增阅读服务类视频 VCEI/fsQCA 组态线 | [literature_review_workbench.md](/Users/leung/ResearchWorkflow/projects/library_short_video/literature/literature_review_workbench.md) |
...
| 状态 | 篇数 | 含义 |
|---|---:|---|
| `skimmed` | 10 | Codex 已带读并写入 reader notes/研讨卡/综述/台账，但还不是人工逐页核验 |
...
1. 下一篇正式精读优先补 `多模态视域下图书馆阅读推广短视频用户体验影响机制研究_程秀峰.pdf`，补王磊 2025 明确缺少的用户感知变量。
2. 把“平台互动-服务触达-阅读推广结果”指标草图细化为 claim-evidence map：VCEI 放平台互动层，服务入口和阅读行为另设指标。
3. 用 `cnki_2025_ea327e3e1c` 的视频表现、内容因素和引流技巧更新内容编码表。
